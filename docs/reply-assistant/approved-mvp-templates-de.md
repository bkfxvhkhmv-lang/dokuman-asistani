# Genehmigte deutsche MVP-Antwortvorlagen - Source of Truth

Diese Datei dient als endgültige Source of Truth für die 20 genehmigten deutschen Antwortvorlagen (Phase 2). Alle Platzhalter verwenden `lowercase_snake_case`. Bedingte Abschnitte werden über strikte `{{#if field_key}}...{{/if}}`-Blöcke gesteuert.
