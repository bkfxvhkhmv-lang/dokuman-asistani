...
export function extrahiereOzetKartlari(dok: Dokument): OzetKarte[] {
  ...
  return [
    { icon: dok.risiko === 'hoch' ? 'warning-circle' : dok.risiko === 'mittel' ? 'warning' : 'check-circle', titel: dok.typ, inhalt: ({ hoch: t(lang, 'document_analysis.summary.high'), mittel: t(lang, 'document_analysis.summary.medium'), niedrig: t(lang, 'document_analysis.summary.low') } as Record<string, string>)[dok.risiko ?? 'niedrig'] || '', aktion: null, aktionLabel: null },
    { icon: betragStr ? 'currency-eur' : 'calendar-blank', titel: betragStr || (fristStr ? t(lang, 'document_analysis.summary.deadline_short', { date: fristStr }) : t(lang, 'document_analysis.summary.no_amount')), inhalt: fristStr ? t(lang, 'document_analysis.summary.due_on', { date: fristStr }) : t(lang, 'document_analysis.summary.no_deadline'), aktion: dok.aktionen?.includes('zahlen') ? 'zahlen' : null, aktionLabel: dok.aktionen?.includes('zahlen') ? t(lang, 'document_analysis.summary.pay_now') : null },
    dok.aktionen?.includes('einspruch') ? { icon: 'pencil-line', titel: t(lang, 'document_analysis.summary.appeal_title'), inhalt: t(lang, 'document_analysis.summary.appeal_body'), aktion: 'einspruch', aktionLabel: t(lang, 'document_analysis.summary.open_template') } : dok.aktionen?.includes('kalender') && dok.frist ? { icon: 'calendar-plus', titel: t(lang, 'document_analysis.summary.calendar_title'), inhalt: t(lang, 'document_analysis.summary.calendar_body'), aktion: 'kalender', aktionLabel: t(lang, 'document_analysis.summary.add') } : { icon: 'archive', titel: t(lang, 'document_analysis.summary.archive_title'), inhalt: t(lang, 'document_analysis.summary.archive_body'), aktion: 'erledigt', aktionLabel: t(lang, 'document_analysis.summary.done') },
  ];
}
